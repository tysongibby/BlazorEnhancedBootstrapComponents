...
{
    public class ExportExcelFile : JSModuleBase
    {
        public ExportExcelFile(IJSRuntime js) : base(js, "/js/ExportFile.js"){ }
        ...
        public static async Task ExportToFileAsync(IJSRuntime iJsRuntime, IXLWorkbook workbook, string fileName)
        {
            ...
            await iJsRuntime.InvokeAsync<ExportExcelFile>(
                "ExportFile",
                fileName + ".xlsx",
                fileTypeString,
        ...
        /// </summary>
        /// <param name="iJsRuntime">Interop JavaScript Runtime or IJSRuntime</param>
        /// <param name="workbook">DataTable to be used to create an IXLWorkbook for export as Excel file to browser client.</param>
        /// <param name="fileName">String of filename to be exported without .xlsx extension</param>
        ...
        public static async Task ExportToFileAsync<T>(IJSRuntime iJsRuntime, List<T> list, string fileName)
        {
            if (iJsRuntime is null)
            {
                throw new ArgumentNullException(nameof(iJsRuntime));
